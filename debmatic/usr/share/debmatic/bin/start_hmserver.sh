...
JAVA_HOME=$JAVA_HOME $JAVA_HOME/bin/java -Xmx128m -Dlog4j.configuration=file:///etc/config/log4j.xml -Dfile.encoding=ISO-8859-1 $JAVA_ARGS -Dgnu.io.rxtx.SerialPorts=$HM_HMIP_DEVNODE -cp ${CLAZZPATH}:/opt/HMServer/$HMSERVER_BIN.jar $HMSERVER_ARGS &
