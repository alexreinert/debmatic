...
ARCHIVE_TAG="060fd6c7995c59f64fc03f29a4a6210428db1767"
...
function build_arch_package {
  ...
  if [ "$ARCH" == "amd64" ]; then
    ...
    run "Download libudev_i386.deb" wget -O libudev_i386.deb http://ftp.debian.org/debian/pool/main/s/systemd/libudev1_247.3-7+deb11u1_i386.deb
    ...
    run "Download libudev_armhf.deb" wget -O libudev_armhf.deb http://ftp.debian.org/debian/pool/main/s/systemd/libudev1_247.3-7+deb11u1_armhf.deb
